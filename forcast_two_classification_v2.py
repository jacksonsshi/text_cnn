...
with tf.Graph().as_default():
    ...
    with sess.as_default() as session:
        ...
        w = open('./ques.txt','r',encoding='utf-8')
        ws = open('ques_cat_v2.txt','a',encoding = 'utf-8')
        line = w.readline()
        ...
        while line:
            ...
            ws.writelines(line.strip()+'----'+result_sorted[0]+'****'+str(result[result_sorted[0]])+'----'+result_sorted[1]+'****'+str(result[result_sorted[1]])+'----'+result_sorted[2]+'****'+str(result[result_sorted[2]])+'\n')
